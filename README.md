# Ronald Kyle J. Valdez

**Business Intelligence Developer | QA Automation | Data Engineering**

Welcome to my portfolio!  
I specialize in building **Power BI dashboards**, **SQL workflows**, and **QA automation scripts** that improve efficiency and data integrity.  
With a decade of experience in BI and QA, I bridge technical rigor with business impact — delivering dashboards, automation tools, and testing frameworks that scale.
...
- **Automation**: Python, VBA, C#, Selenium  
- **Cloud & Tools**: Azure, DevOps, Power Platform  
- **QA & Testing**: Automated workflows, data integrity validation  

---

## 🌟 Highlight Projects
- **SQL Integrity Checker** → Reduced QA testing time from 3 hours to 30 minutes.  
- **Power BI QA Toolkit** → Validated 10+ dashboards with 97% data quality.  
- **Selenium Automation Demo** → Automated Power Apps testing, improving efficiency by 20%.  

---

## 📬 Contact
📧 ronaldvaldez1134@gmail.com  
📱 +63 (932) 870-9255  
